...
namespace BankingServices
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("4)  Account Active?     (bool)   current: false   [enter 1=yes / 0=no] " + isActive + "   [enter 1=yes / 0=no]");
            ...
            Console.WriteLine("7)  Monthly Salary      (double) current: 0.000 OMR " + salary.ToString("0.000") + " OMR");
            Console.WriteLine("8)  Credit Score        (int)    current: 0 " + creditScore);
            Console.WriteLine("9)  Age                 (int)    current: 0 " + age);
            Console.WriteLine(" --- Transaction Data ---");
            Console.WriteLine("10) Last Deposit Amount (double) current: 0.000 OMR" + deposit.ToString("0.000") + " OMR");
            Console.WriteLine("11) Last Withdrawal     (double) current: 0.000 OMR" + withdrawal.ToString("0.000") + " OMR");
